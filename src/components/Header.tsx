...
const Header = ({ activeRole, onRoleSelect }: HeaderProps) => {
  return (
    <header className="relative mb-10 overflow-hidden rounded-3xl glass p-8 md:p-12" role="banner">
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="text-xl md:text-2xl opacity-90 font-light mb-8 animate-fadeIn" style={{ animationDelay: '0.1s' }}>
